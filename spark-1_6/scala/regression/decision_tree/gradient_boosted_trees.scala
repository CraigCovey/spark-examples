...
/* =============================================================================
This Spark Scala 1.6 script uses gradient-boosted tree regression machine learning to
...
object RandomForest {
    ...
    def main(args: Array[String]) : Unit = {
        ...
        */
        ...
        print("Gradient-Boosted Trees (GBTs) are ensembles of decision trees. GBTs iteratively train decision trees in order to minimize a loss function. ")
        ...
        print("The specific mechanism for re-labeling instances is defined by a loss function. With each iteration, GBTs further reduce this loss function on the training data.")
        ...
        println("Max iterations: " + tree.getMaxIter)
        println("Step size: " + tree.getStepSize)
        println("Sub-sampling rate: " + tree.getSubsamplingRate)
        ...
        println("Tree weights: " + treeModel.treeWeights.mkString(", "))
